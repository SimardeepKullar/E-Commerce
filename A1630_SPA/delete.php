    ...
    <body>
        ...
        <main>
            <section class="checkoutSection" style="border: 1px solid white">
                ...
                <form method="post">
                    <h1 style="text-align:center">Delete Query</h1>
                    <label for="delete"><b>Query</b></label>
                    <input type="text" id="delete" placeholder="DELETE FROM table_name WHERE condition;" name="delete" required>
                    <button type="submit" name="deleteButton">Run Delete</button>
                </form>
            </section>
