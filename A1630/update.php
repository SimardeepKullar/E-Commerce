...
<html lang="en">
    ...
    <header>
        ...
        <section class="checkoutSection" style="border: 1px solid white">
            ...
            <form method="post">
                <h1 style="text-align:center">Update Query</h1>
                <label for="updateTable"><b>Table</b></label>
                <input type="text" id="updateTable" placeholder="UPDATE table_name" name="updateTable" required>
                <label for="updateSet"><b>Set</b></label>
                <input type="text" id="updateSet" placeholder="SET column1 = value1, column2 = value2, ..." name="updateSet" required>
                <label for="updateWhere"><b>Where</b></label>
                <input type="text" id="updateWhere" placeholder="WHERE condition;" name="updateWhere" required>
                <button type="submit" name="updateButton">Run Update</button>
            </form>
        </section>
